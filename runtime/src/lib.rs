...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("clueconn"),
	impl_name: create_runtime_str!("clueconn-node"),
	authoring_version: 0,
	spec_version: 16,
	impl_version: 0,
...
// Clueconn custom pallets go below:
// ------------------------------------------------------------------------------------------------
